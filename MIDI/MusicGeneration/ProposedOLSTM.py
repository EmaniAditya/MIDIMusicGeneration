...
class ProposedOLSTM:
    def train_network(self):
        ...
        def create_network(network_input_notes, n_vocab_notes, network_input_offsets, n_vocab_offsets,
        ...
        def train(model, network_input_notes, network_input_offsets, network_input_durations,
                  network_output_notes,
                  network_output_offsets, network_output_durations):
            """ train the neural network """
            filepath = "..\\Models\\POLSTMweights.hdf5"
            ...
            model.fit([network_input_notes, network_input_offsets, network_input_durations],
                      [network_output_notes, network_output_offsets, network_output_durations], epochs=1000,
                      batch_size=64,
        ...
        model = create_network(network_input_notes, n_vocab_notes, network_input_offsets, n_vocab_offsets,
                               network_input_durations, n_vocab_durations)

        # train(model, network_input_notes, network_output_notes)

        train(model, network_input_notes, network_input_offsets, network_input_durations, network_output_notes,
              network_output_offsets, network_output_durations)
    ...
    def testing(self, iptsdata):
        ...
        cfg.polstmcm = cm
        cfg.polstmacc = accuracy
        cfg.polstmpre = precision
        cfg.polstmrec = recall
        cfg.polstmfsc = fscore
        cfg.polstmsens = sensitivity
        cfg.polstmspec = specificity
